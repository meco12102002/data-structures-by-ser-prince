...
function BinaryTreeLesson() {
  return (
    <>
      ...
      <SEO
        title="Binary Trees Explained | Interactive Data Structures Lesson"
        description="Learn binary trees through interactive visualizations and hands-on practice. Understand nodes, parents, children, leaves, depth, edges, subtrees, and tree traversal."
      ...
      <main className="binary-tree-lesson">
        ...
        <section
          ...
          aria-labelledby="binary-tree-introduction"
        >
          ...
          <h2 id="binary-tree-introduction">
        ...
        <section
          ...
          aria-labelledby="traversal-introduction"
        >
